...
private:
	...
	KamataEngine::Vector3 spriteRightPos_ = {300.0f, 300.0f, 0.0f}; // スプライトの左上位置（ピクセル）
	KamataEngine::Vector3 spriteLeftPos_ = {80.0f, 300.0f, 0.0f};   // スプライトの左上位置（ピクセル）
	KamataEngine::Vector3 spriteSize_ = {150.0f, 150.0f, 0.0f};     // スプライトのサイズ（ピクセル）
